/**
 * Applies supabase/migrations/20250623130000_upi_verification_pending.sql
 *
...
const sql = readFileSync(
  resolve(root, "supabase/migrations/20250623130000_upi_verification_pending.sql"),
  "utf8",
);
...
try {
  ...
  console.log("Connected. Applying UPI verification_pending migration…");
