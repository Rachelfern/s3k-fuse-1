/**
 * Applies supabase/migrations/20250623110000_payment_method.sql
 *
...
const sql = readFileSync(
  resolve(root, "supabase/migrations/20250623110000_payment_method.sql"),
  "utf8",
);
...
try {
  ...
  console.log("Connected. Applying payment_method migration…");
