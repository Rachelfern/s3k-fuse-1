/**
 * Applies supabase/migrations/20250623140000_ai_ops_payment_screenshots.sql
 *
...
const sql = readFileSync(
  resolve(root, "supabase/migrations/20250623140000_ai_ops_payment_screenshots.sql"),
  "utf8",
);
...
try {
  ...
  console.log("Connected. Applying payment screenshots + AI ops migration…");
