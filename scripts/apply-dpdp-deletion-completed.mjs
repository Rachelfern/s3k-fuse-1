/**
 * Applies supabase/migrations/20250623150000_dpdp_deletion_completed.sql
 *
...
const sql = readFileSync(
  resolve(root, "supabase/migrations/20250623150000_dpdp_deletion_completed.sql"),
  "utf8",
);
...
try {
  ...
  console.log("Connected. Applying DPDP deletion completed migration…");
